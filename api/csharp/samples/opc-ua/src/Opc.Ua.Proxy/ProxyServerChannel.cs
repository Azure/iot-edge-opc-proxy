...
namespace Opc.Ua.Proxy
{
    ...
    /// </summary>
    public class ProxyServerChannel : ProxyChannel
    {
        #region Constructors
        /// <summary>
        /// Attaches the object to an existing socket.
        /// </summary>
        public ProxyServerChannel(
            string                        contextId,
            ProxyTransportListener          listener,
        ...
        /// </summary>
        public void SetRequestReceivedCallback(ProxyChannelRequestEventHandler callback)
        {
            lock (DataLock)
            {
        ...
        public void Attach(uint channelId, Socket socket)
        {
            ...
            lock (DataLock)
            {
                ...
                Socket = new ProxyMessageSocket(this, socket, BufferManager, Quotas.MaxBufferSize);
        ...
        private ProxyChannelRequestEventHandler m_RequestReceived;
        private long m_lastTokenId;
        private ProxyTransportListener m_listener;
        private SortedDictionary<uint,IServiceResponse> m_queuedResponses;
        private Timer m_cleanupTimer;
        private bool m_responseRequired;
        private const string g_ImplementationString = "ProxyServerChannel UA-TCP";
        #endregion
    }
    ...
    /// </summary>
    public delegate void ProxyChannelRequestEventHandler(ProxyServerChannel channel, uint requestId, IServiceRequest request);
}
