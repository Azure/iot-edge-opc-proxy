...
namespace Opc.Ua.Bindings
{
    ...
    /// </summary>
    public partial class ProxyChannel : IProxyMessageSink, IDisposable
    {
        #region Constructors
        /// <summary>
        ...
        /// </summary>
        public void SetStateChangedCallback(ProxyChannelStateEventHandler callback)
        {
            lock (m_lock)
            {
        ...
        #region IProxyMessageSink Members
        /// <summary>
        /// Processes an incoming message.
        /// </summary>
        public virtual void OnMessageReceived(ProxyMessageSocket source, ArraySegment<byte> message)
        {
            lock (DataLock)
            {
                try
        ...
        /// </summary>
        public virtual void OnReceiveError(ProxyMessageSocket source, ServiceResult result)
        {
            lock (DataLock)
            {
        ...
        protected void BeginWriteMessage(ArraySegment<byte> buffer, object state)
        {
            ...
            try
            {
                ...
                if (!m_socket.m_socket.SendAsync(args))
                {
                    ...
                    if ((args.SocketError != SocketError.Ok) || (args.BytesTransferred < buffer.Count))
                    {
        ...
        protected void BeginWriteMessage(BufferCollection buffers, object state)
        {
            ...
            try
            {
                ...
                args.Completed += OnWriteComplete;
                args.UserToken = state;
                args.SocketError = SocketError.Closed;
                if (m_socket == null ||
                    m_socket.m_socket == null ||
                    !m_socket.m_socket.SendAsync(args))
                {
                    // I/O completed synchronously
                    if ((args.SocketError != SocketError.Ok) || (args.BytesTransferred < buffers.TotalSize))
                    {
                        error = ServiceResult.Create(StatusCodes.BadConnectionClosed, args.SocketError.ToString());
                    }
        ...
        /// </summary>
        protected ProxyMessageSocket Socket
        {
            get { return m_socket;  }            
        ...
        private ProxyMessageSocket m_socket;
        ...
        private ProxyChannelStateEventHandler m_StateChanged;
        #endregion
    }
    ...
    /// </summary>
    public delegate void ProxyChannelStateEventHandler(ProxyChannel channel, TcpChannelState state, ServiceResult error);
