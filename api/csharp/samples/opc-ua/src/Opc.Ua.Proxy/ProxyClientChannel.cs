...
namespace Opc.Ua.Bindings
{
    ...
    /// </summary>
    public class ProxyClientChannel : ProxyChannel
    {
        #region Constructors
        /// <summary>
        /// Creates a channel for for a client.
        /// </summary>
        public ProxyClientChannel(
            string              contextId,
        ...
        private void OnConnectComplete(object sender, SocketAsyncEventArgs e)
        {
            ...
            if (e.SocketError != SocketError.Ok)
            {
        ...
        private const string g_ImplementationString = "ProxyClientChannel UA-TCP";
        #endregion
    }
}
