...
#ifdef io_queue_buffer_write

//
//Test io_queue_buffer_write happy path 
// 
TEST_FUNCTION(io_queue_buffer_write__success)
{
    static const io_queue_buffer_t* k_buffer_valid;
    ...
    // act 
    result = io_queue_buffer_write(k_buffer_valid, k_buf_valid, k_len_valid);
...
// 
// Test io_queue_buffer_write passing as buffer argument an invalid io_queue_buffer_t* value 
// 
TEST_FUNCTION(io_queue_buffer_write__arg_buffer_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(io_queue_buffer_write__arg_buf_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(io_queue_buffer_write__arg_len_invalid)
{
    // ... 
    int32_t result;
...
#endif // io_queue_buffer_write;

#ifdef io_queue_buffer_read

//
//Test io_queue_buffer_read happy path 
// 
TEST_FUNCTION(io_queue_buffer_read__success)
{
    static const io_queue_buffer_t* k_buffer_valid;
    ...
    // act 
    result = io_queue_buffer_read(k_buffer_valid, k_buf_valid, k_len_valid, k_read_valid);
...
// 
// Test io_queue_buffer_read passing as buffer argument an invalid io_queue_buffer_t* value 
// 
TEST_FUNCTION(io_queue_buffer_read__arg_buffer_invalid)
{
    // ... 
    int32_t result;
...
// 
// Test io_queue_buffer_read unhappy path 
// 
TEST_FUNCTION(io_queue_buffer_read__neg)
{
    static const io_queue_buffer_t* k_buffer_valid;
    static const void* k_buf_valid;
    static const size_t k_len_valid;
