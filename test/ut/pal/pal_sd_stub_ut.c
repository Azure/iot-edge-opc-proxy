...
// 
TEST_FUNCTION(pal_stub_sdclient_create__success)
{
...
// 
TEST_FUNCTION(pal_stub_sdclient_create__arg_client_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdclient_create__neg)
{
    static const pal_sdclient_t** k_client_valid;
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdbrowser_create__arg_browser_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdbrowser_browse__arg_browser_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdbrowser_free__arg_browser_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdclient_release__success)
{
    static const pal_sdclient_t* k_client_valid;
    void result;
...
// 
TEST_FUNCTION(pal_stub_sdclient_release__arg_client_invalid)
{
    // ... 
    int32_t result;
...
// 
TEST_FUNCTION(pal_stub_sdclient_release__neg)
{
    static const pal_sdclient_t* k_client_valid;
    void result;
